基于koa 2.0轻量、易扩展的声明式框架，框架以loader模块加载器为核心，通过app对象贯穿整个应用，为项目提供便捷的功能扩展及快捷的跨模块引用等特性。
...
传统插件机制出于资源冲突的考虑，放弃了对路由的支持。但不仅仅是路由，在同一个app对象中扩展middleware、controller等其它功能也同样面临同名资源冲突的问题。
