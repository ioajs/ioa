...
function createApp(pathName, parent) {
   ...
   if (app === undefined) {
      ...
      try {
         ...
         throw consoln.error(`未找到“${pathName}”组件, 请检查“${$path}”下是否存在入口文件`);
      }
      ...
      global.__scope__ = app; // 供模块作用域临时读取的app对象
      ...
      try {
         ...
         fs.outputFileSync(scopePath, `module.exports = global.__scope__;`);
